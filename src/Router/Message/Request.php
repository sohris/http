...
final class Request extends AbstractRequest implements ServerRequestInterface
{
    public $REQUEST = [];
    public $SESSION = [];
    public $FILES = [];
    ...
    {
        return new self($request->getMethod(),$request->getUri(),$request->getHeaders(), $request->getBody(), $request->getProtocolVersion(), $request->getServerParams());
    }
